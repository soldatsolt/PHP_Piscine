<?php
	...
	else
	{
		...
		if ($f != -1 && isset($login) && isset($passwd) && $array[$f]['passwd'] == hash('whirlpool',$passwd))
...
<body>
    ...
    <div class="main">
		...
		<div class="home-txt1">
            <h1>Registration</h1>
            <div class="form.txt">
				<form class="form_sign" action="sign_in.php" method="POST">
					<input class="forms" name="login" type="text" placeholder="Enter login" value="batman">
					<br>
					<input class="forms" name="passwd" type="text" placeholder="Enter password" value="">
					<br>
					<input class="butonform1" name="submit" type="submit" value="OK"><br />
					<a  href="index.php"><input class="butonform1" name="submit" type="submit" value="Return"><br /></a>
				</form>
        	</div>
    	</div>	
